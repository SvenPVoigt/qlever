...
public interface SparqlAutomaticListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link SparqlAutomaticParser#stepsMin}.
	 * @param ctx the parse tree
	 */
	void enterStepsMin(SparqlAutomaticParser.StepsMinContext ctx);
	/**
	 * Exit a parse tree produced by {@link SparqlAutomaticParser#stepsMin}.
	 * @param ctx the parse tree
	 */
	void exitStepsMin(SparqlAutomaticParser.StepsMinContext ctx);
	/**
	 * Enter a parse tree produced by {@link SparqlAutomaticParser#stepsMax}.
	 * @param ctx the parse tree
	 */
	void enterStepsMax(SparqlAutomaticParser.StepsMaxContext ctx);
	/**
	 * Exit a parse tree produced by {@link SparqlAutomaticParser#stepsMax}.
	 * @param ctx the parse tree
	 */
	void exitStepsMax(SparqlAutomaticParser.StepsMaxContext ctx);
	/**
