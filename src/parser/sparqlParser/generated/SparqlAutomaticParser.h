...
public:
  ...
  enum {
    ...
    RuleFoo = 103, RulePathPrimary = 104, RulePathNegatedPropertySet = 105, 
    RulePathOneInPropertySet = 106, RuleInteger = 107, RuleTriplesNode = 108, 
    RuleBlankNodePropertyList = 109, RuleTriplesNodePath = 110, RuleBlankNodePropertyListPath = 111, 
    RuleCollection = 112, RuleCollectionPath = 113, RuleGraphNode = 114, 
    RuleGraphNodePath = 115, RuleVarOrTerm = 116, RuleVarOrIri = 117, RuleVar = 118, 
    RuleGraphTerm = 119, RuleExpression = 120, RuleConditionalOrExpression = 121, 
    RuleConditionalAndExpression = 122, RuleValueLogical = 123, RuleRelationalExpression = 124, 
    RuleNumericExpression = 125, RuleAdditiveExpression = 126, RuleMultiplicativeExpressionWithSign = 127, 
    RulePlusSubexpression = 128, RuleMinusSubexpression = 129, RuleMultiplicativeExpressionWithLeadingSignButNoSpace = 130, 
    RuleMultiplicativeExpression = 131, RuleMultiplyOrDivideExpression = 132, 
    RuleMultiplyExpression = 133, RuleDivideExpression = 134, RuleUnaryExpression = 135, 
    RulePrimaryExpression = 136, RuleBrackettedExpression = 137, RuleBuiltInCall = 138, 
    RuleRegexExpression = 139, RuleLangExpression = 140, RuleSubstringExpression = 141, 
    RuleStrReplaceExpression = 142, RuleExistsFunc = 143, RuleNotExistsFunc = 144, 
    RuleAggregate = 145, RuleIriOrFunction = 146, RuleRdfLiteral = 147, 
    RuleNumericLiteral = 148, RuleNumericLiteralUnsigned = 149, RuleNumericLiteralPositive = 150, 
    RuleNumericLiteralNegative = 151, RuleBooleanLiteral = 152, RuleString = 153, 
    RuleIri = 154, RulePrefixedName = 155, RuleBlankNode = 156, RuleIriref = 157, 
    RulePnameLn = 158, RulePnameNs = 159
  };
  ...
  class  FooContext : public antlr4::ParserRuleContext {
  public:
    FooContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
